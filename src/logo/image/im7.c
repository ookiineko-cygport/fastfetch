...
FFLogoImageResult ffLogoPrintImageIM7(FFLogoRequestData* requestData)
{
    FF_LIBRARY_LOAD(imageMagick, &instance.config.library.libImageMagick, FF_LOGO_IMAGE_RESULT_INIT_ERROR,
        FF_LIBRARY_PREFIX "MagickCore-7.Q16HDRI" FF_LIBRARY_EXTENSION, 11,
        FF_LIBRARY_PREFIX "MagickCore-7.Q16" FF_LIBRARY_EXTENSION, 11,
        FF_LIBRARY_PREFIX "MagickCore-7.Q16HDRI-9" FF_LIBRARY_EXTENSION, -1, // Required for Cygwin
        FF_LIBRARY_PREFIX "MagickCore-7.Q16HDRI-10" FF_LIBRARY_EXTENSION, -1 // Required for Windows
    )
