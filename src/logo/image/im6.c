...
FFLogoImageResult ffLogoPrintImageIM6(FFLogoRequestData* requestData)
{
    FF_LIBRARY_LOAD(imageMagick, &instance.config.library.libImageMagick, FF_LOGO_IMAGE_RESULT_INIT_ERROR,
        FF_LIBRARY_EXTENSION "MagickCore-6.Q16HDRI" FF_LIBRARY_EXTENSION, 8,
        FF_LIBRARY_EXTENSION "MagickCore-6.Q16" FF_LIBRARY_EXTENSION, 8,
        FF_LIBRARY_EXTENSION "MagickCore-6.Q16-6" FF_LIBRARY_EXTENSION, -1 // Required for Cygwin
    )
