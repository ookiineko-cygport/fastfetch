...
static const char* getXfce4ByLib(FFstrbuf* result)
{
    ...
    FF_LIBRARY_LOAD(xfce4util, NULL, "dlopen " FF_LIBRARY_PREFIX "xfce4util" FF_LIBRARY_EXTENSION "failed",
        FF_LIBRARY_PREFIX "xfce4util" FF_LIBRARY_EXTENSION, 7,
        FF_LIBRARY_PREFIX "xfce4util-7" FF_LIBRARY_EXTENSION, -1 // Required for Cygwin
    );
