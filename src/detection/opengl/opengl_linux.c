...
static const char* eglPrint(FFOpenGLResult* result)
{
    ...
    FF_LIBRARY_LOAD(egl, &instance.config.library.libEGL, "dlopen egl failed",
        FF_LIBRARY_PREFIX "EGL" FF_LIBRARY_EXTENSION, 1,
        FF_LIBRARY_PREFIX "EGL-1" FF_LIBRARY_EXTENSION, -1 // Required Cygwin
    );
...
static const char* glxPrint(FFOpenGLResult* result)
{
    ...
    FF_LIBRARY_LOAD(glx, &instance.config.library.libGLX, "dlopen glx failed", FF_LIBRARY_PREFIX "GLX" FF_LIBRARY_EXTENSION, 1);
...
static const char* osMesaPrint(FFOpenGLResult* result)
{
    ...
    FF_LIBRARY_LOAD(osmesa, &instance.config.library.libOSMesa, "dlopen osmesa failed",
        FF_LIBRARY_PREFIX "OSMesa" FF_LIBRARY_EXTENSION, 8,
        FF_LIBRARY_PREFIX "OSMesa-8" FF_LIBRARY_EXTENSION, -1 // Required for Cygwin
    );
