...
{
    FF_LIBRARY_LOAD(x11, &instance.config.library.libX11, ,
        FF_LIBRARY_PREFIX "X11" FF_LIBRARY_EXTENSION, 7,
        FF_LIBRARY_PREFIX "X11-6" FF_LIBRARY_EXTENSION, -1, // Required for Cygwin
        FF_LIBRARY_PREFIX "X11-xcb" FF_LIBRARY_EXTENSION, 2,
        FF_LIBRARY_PREFIX "X11-xcb-1" FF_LIBRARY_EXTENSION, -1 // Required for Cygwin
    )
...
{
    FF_LIBRARY_LOAD(xrandr, &instance.config.library.libXrandr, ,
        FF_LIBRARY_PREFIX "Xrandr" FF_LIBRARY_EXTENSION, 3,
        FF_LIBRARY_PREFIX "Xrandr-2" FF_LIBRARY_EXTENSION, -1 // Required for Cygwin
    )
