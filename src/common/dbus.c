...
{
    FF_LIBRARY_LOAD(dbus, &instance.config.library.libDBus, false,
        FF_LIBRARY_PREFIX "dbus-1" FF_LIBRARY_EXTENSION, 4,
        FF_LIBRARY_PREFIX "dbus-1-3" FF_LIBRARY_EXTENSION, -1 // Required for Cygwin
    );
